...
class Limiter(commands.Cog):
    ...
    @commands.group(name="limit", aliases=["limiter"], description="Limits content allowed in a channel")
    ...
    @commands.command(name="unlimit", description="Removes channel content limits")
    ...
    @limit.command(name="images", description="Limits a channel to images")
    @commands.has_permissions(manage_messages=True)
    ...
    @limit.command(name="yt-links", description="Limits a channel to YouTube links")
    @commands.has_permissions(manage_messages=True)
    @commands.bot_has_permissions(manage_messages=True)
    ...
    @limit.command(name="invites", description="Limits a channel to Discord invites")
    @commands.has_permissions(manage_messages=True)
    @commands.bot_has_permissions(manage_messages=True)
...
async def setup(bot):
    await bot.add_cog(Limiter(bot), override=True)
