...
class Music(commands.Cog):
    def __init__(self, bot):
        ...
        # Node credentials belong in the encrypted auth configuration. The
        # previous well-known source default made an exposed Lavalink service
        # trivial to take over.
        for node in bot.auth.get("Lavalink", []):
    ...
    async def cog_unload(self):
        ...
        for node in list(self.bot.lavalink.node_manager.nodes):
    ...
    async def cog_before_invoke(self, ctx):
        ...
        if ctx.channel.permissions_for(ctx.guild.me).manage_messages:
            task = self.bot.loop.create_task(delete_after())
    ...
    @commands.command(aliases=['p'], description="Plays a track or adds it to the queue")
    ...
    @commands.command(name="queue", aliases=["q"], description="Shows the current music queue")
    ...
    @commands.command(name="disconnect", aliases=['dc'], description="Disconnects the music player")
    ...
    @commands.command(name="stop", description="Stops playback and clears the queue")
    @ensure_player_is_playing()
    ...
    @commands.command(name="repeat", description="Toggles repeating the current track")
    @ensure_player_is_playing()
    ...
    @commands.command(name="remove", description="Removes a track from the queue")
    @ensure_player_is_playing()
    ...
    @commands.command(name="seek", aliases=["s"], description="Seeks within the current track")
    @ensure_player_is_playing()
    ...
    @commands.command(name="playat", description="Moves a queued track to play next")
    @ensure_player_is_playing()
    ...
    @commands.command(name="pause", description="Pauses music playback")
    @ensure_player_is_playing()
    ...
    @commands.command(name="resume", description="Resumes music playback")
    @ensure_player_is_playing()
    ...
    @commands.command(name="volume", aliases=["vol", "v"], description="Changes the playback volume")
    @ensure_player_is_playing()
    ...
    @commands.command(
        name="now",
        aliases=["np", "playing", "current", "cur"],
    ...
    @commands.command(name="shuffle", description="Shuffles the current music queue")
    @ensure_player_is_playing()
    @require_voting()
    ...
    @commands.command(name="thumbnail", description="Shows the current track thumbnail")
    @ensure_player_is_playing()
...
async def setup(bot):
    await bot.add_cog(Music(bot), override=True)
