...
class Cookies(commands.Cog):
    ...
    @commands.command(name="cookie", description="Gives a cookie to another member")
    ...
    @commands.command(name="cookies", description="Shows a member's cookie count")
...
async def setup(bot):
    await bot.add_cog(Cookies(bot), override=True)
